...
/* Los datos del menú y las promos viven en js/datos.js (se carga antes). */
...
function initMenu() {
  ...
  const tarjetas = MENU.map((item) => {
    ...
    // Ingredientes: fichas escalonadas; el botón "i" las abre en táctil.
    const chips = card.querySelector('.chips');
    (item.ing || []).forEach((nombre, i) => {
